...
class ProductSerializer(serializers.ModelSerializer):
    ...
    price_with_tax = serializers.SerializerMethodField(method_name = 'taxe_calculator')
    
    def taxe_calculator(self, product:Product):
...
class CartItemsSerializer(serializers.ModelSerializer):
    ...
    total_price = serializers.SerializerMethodField(method_name='get_TotalPrice')
    def get_TotalPrice(self,cart_items:CartItem):
            return cart_items.product.unit_price*cart_items.quantity
...
class AddCartItemsSerializers(serializers.ModelSerializer):
...
class CreateOrderSerializer(serializers.Serializer):
    ...
    def validate_cart_id(self, cart_id):
        ...
        if CartItem.objects.filter(pk=cart_id).count()==0:
            raise serializers.ValidationError("An Empty Cart")
